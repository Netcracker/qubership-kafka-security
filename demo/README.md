...
```
volumes:
  - ../kafka-security-oauth-server/target/kafka-security-oauth-server-0.11.0-3.9.1.jar:/opt/kafka/libs/kafka-security-oauth-server-2.7.1-3.1.jar
  - ../kafka-security-oauth-client/target/kafka-security-oauth-client-0.11.0-3.9.1.jar:/opt/kafka/libs/kafka-security-oauth-client-2.7.1-3.1.jar
```
